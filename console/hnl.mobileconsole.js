...
function keyShortcuts(e) {
    ...
    if (e.code == "F12") {
      e.preventDefault();
    if (document.querySelector('.mobile-console').style.display != "none") {
        document.querySelector('.mobile-console').style.display = "none";
      }
    else { 
        document.querySelector('.mobile-console').style.display = "block"; }
    } 
  }
document.addEventListener('keydown', keyShortcuts);

// add the following to bottom of html
/*
<script type="text/javascript">
	setTimeout(() => {
	document.querySelector('.mobile-console').style.display
	= "none"; }, "10")	
</script>
* */
